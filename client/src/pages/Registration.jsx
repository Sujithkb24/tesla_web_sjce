...
const Registration = () => {
  ...
  const branches = ['CSE', 'ISE', 'CSBS', 'ECE', 'EIE', 'IP', 'MECH', 'CIVIL', 'EEE','Other'];
  const years = ['1', '2', '3', '4'];

  // Quiz Details
  const quizDetails = {
    theme: 'Tech Trivia Extravaganza',
    date: '18th JAN, 2026',
        ...
        <div className="max-w-6xl mx-auto px-6 py-12 md:py-16 lg:py-28 grid grid-cols-1 lg:grid-cols-[2fr,1fr] gap-10 items-center">
          ...
          <div>
            ...
            <h1 className="text-3xl font-sans md:text-4xl lg:text-6xl font-extrabold leading-tight mb-4">
              Tech Trivia <span className="text-[#c9a154]">Extravaganza</span>
            </h1>
            <p className="text-sm md:text-base text-zinc-300 max-w-4xl font-medium mb-10">
              Test your technical knowledge in this exciting quiz. From algorithms to emerging tech - 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col gap-1">
                ...
                <span className="text-lg md:text-xl font-bold text-[#c9a154]">
                  {quizDetails.date}
                </span>
              </div>
              <div className="flex flex-col gap-1">
          ...
          <div className="border border-zinc-800 rounded-2xl p-6 md:p-7 bg-zinc-950/70 backdrop-blur-sm flex flex-col gap-5 shadow-[0_0_20px_-4px_rgba(0,0,0,0.7)]">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-s text-zinc-300 leading-relaxed font-medium">
                <li className="flex gap-2"><span className="text-[#c9a154]">•</span>Open to all engineering students</li>
                <li className="flex gap-2"><span className="text-[#c9a154]">•</span>50 questions, 60 minutes</li>
                <li className="flex gap-2"><span className="text-[#c9a154]">•</span>MCQ format, no negative marking</li>
                <li className="flex gap-2"><span className="text-[#c9a154]">•</span>Top 3 win exciting prizes</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8 sm:mb-10 text-center">
            ...
            <p className="text-sm sm:text-base text-zinc-400 font-medium max-w-2xl mx-auto">
              Fill your details to secure your spot. One seat per student.
            </p>
          </div>
          ...
          <div className="border border-zinc-900 bg-zinc-950/80 rounded-3xl p-5 sm:p-6 md:p-8 lg:p-10 shadow-[0_0_60px_rgba(0,0,0,0.9)]">
            <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
              ...
              <div className="lg:col-span-2">
                <div className="rounded-2xl border border-zinc-900 bg-black/70 p-5 sm:p-6 md:p-8 space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="flex flex-col">
                      <label className="label-dark mb-1">USN *</label>
                      <input
                        type="text"
                        name="usn"
                        value={formData.usn}
                    ...
                    <div className="flex flex-col">
                      <label className="label-dark mb-1">Contact Number *</label>
                      <input
                        type="tel"
                        name="contactNumber"
              ...
              {/* Question */}
              <div className="lg:col-span-2">
                <div className="rounded-2xl border border-zinc-900 bg-black/70 p-5 sm:p-6 md:p-8 space-y-4">
                  <h3 className="text-lg sm:text-xl font-bold">Have you attended this quiz before?</h3>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-2">
                    <label className="flex items-center gap-3 p-4 rounded-xl border border-zinc-800 bg-zinc-950/40 hover:border-zinc-600 cursor-pointer transition-all group">
                      ...
                      />
                      <span className="text-sm font-medium text-zinc-200 group-hover:text-white">Yes</span>
                    </label>
                    ...
                    <label className="flex items-center gap-3 p-4 rounded-xl border border-zinc-800 bg-zinc-950/40 hover:border-zinc-600 cursor-pointer transition-all group">
                      <input
                        ...
                        className="w-5 h-5 accent-[#c9a154] text-[#c9a154]"
                      />
                      <span className="text-sm font-medium text-zinc-200 group-hover:text-white">No</span>
                    </label>
                  </div>
                </div>
              </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
            <div className="bg-zinc-900/90 border border-[#c9a154]/40 rounded-2xl p-8 w-11/12 max-w-md shadow-xl animate-scaleIn text-center space-y-4">
              ...
              <p className="text-zinc-300 text-sm md:text-base font-medium leading-relaxed">
                You're all set for the <strong>{quizDetails.theme}</strong>!<br />
                Join our WhatsApp group for updates.
              </p>
              <a
                href="https://chat.whatsapp.com/Co6CYAog3ioBMmbFrBxGs1" 
                target="_blank"
