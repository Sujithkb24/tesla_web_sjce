...
const teamSections = [
  ...
  },
  {
    ...
    members: [
      ...
      },
      {
        name: "K Vikas Gowda",
        role: "Member",
        image: "Tesla_photos/Program Coordination/VikasGowda.jpeg",
        description: "EEE - 1st Year",
      },
      {
        name: "Pranav Bhat",
  ...
  //     { name: "Rohith", role: "Member", image: "/Default2.jpg", description: "Contributes to project deployment and monitoring." }
  //   ],
  // },
              ...
              return (
                <div className="group relative w-72 overflow-hidden rounded-2xl border border-yellow-300 bg-black shadow-lg transition-all duration-300 hover:shadow-yellow-500">
                  ...
                  <div className="absolute bottom-0 z-10 w-full translate-y-10 p-5 text-center transition-all duration-300 group-hover:translate-y-0">
                    ...
                    <h3 className="text-xl font-semibold text-yellow-400 relative">
                      {member.name}
                    </h3>
                    <p className="text-sm mt-1 text-gray-300 relative">
                      {member.role}
                    </p>

                    {/* Divider */}
                    <div className="mx-auto mt-3 mb-3 h-[2px] w-12 bg-yellow-500 relative" />
                  </div>
