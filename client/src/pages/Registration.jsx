...
const Registration = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      {/* Hero Section */}
      <section className="relative w-full border-b border-[#c9a154]/30 bg-gradient-to-b from-black via-black to-zinc-900 overflow-hidden">
        {/* Subtle gold glow */}
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-4 text-zinc-300 font-medium">
                {[
                  ...
                  "MCQ format, no negative marking",
                  "Top 3 win exciting prizes",
                ].map((rule, i) => (
